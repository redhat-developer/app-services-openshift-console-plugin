...
export const rhoasCatalogPlugin: Plugin<CatalogConsumedExtensions> = [
  {
    ...
    properties: {
      ...
      catalogDescription: '%rhoas-plugin~Browse managed services to connect applications and microservices to other services and support services to create a full solution.%',
